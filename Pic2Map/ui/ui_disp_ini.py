...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lineEditDEM = QtGui.QLineEdit(Dialog)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.radioButton.setText(_translate("Dialog", "GCP approach", None))
        self.radioButton_2.setText(_translate("Dialog", "Virtual 3D approach", None))
