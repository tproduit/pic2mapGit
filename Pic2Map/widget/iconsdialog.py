...
class icons_dialog(QtGui.QDialog):
    ...
    def __init__(self, iconSet):
        ...
        self.uiIcons.colorMButton.clicked.connect(
            partial(self.showColor, self.uiIcons.colorMButton))
        self.uiIcons.colorCButton.clicked.connect(
            partial(self.showColor, self.uiIcons.colorCButton))
