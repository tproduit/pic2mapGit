...
class Buffers(QtGui.QWidget):
    ...
    def getBuffer(self):
        box = [self.temp_dem_box.xMinimum(), self.temp_dem_box.yMinimum(
        ), self.temp_dem_box.xMaximum(), self.temp_dem_box.yMaximum()]
        bar = progress_bar()
        bar.show()
        ...
        self.dem_box = [box[0] + resolution1 / 2, box[1] + resolution1 /
                        2, box[2] - resolution1 / 2, box[3] - resolution1 / 2]
        res = resolution1
        self.res = res
