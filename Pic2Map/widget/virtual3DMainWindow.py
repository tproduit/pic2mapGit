...
class Virtual3DMainWindow(QMainWindow):
    ...
    def __init__(self, pointBuffer, picture_name, crs, pathToData):
        ...
        self.D3_instance = D3_view(
            pointBuffer, picture_name, 0, 45, transparency=50)
        ...
        self.ui.horizontalSlider_3.valueChanged.connect(
            self.sliderTransparency)
    ...
    def closeEvent(self, event):
        # When the window is closed, the parameters get fixed and are used for
        # the monoplotter
        self.ParamPose = [self.D3_instance.pos, self.D3_instance.lookat,
                          self.D3_instance.FOV, self.D3_instance.roll]
    ...
    def savePoseInKML(self):
        ...
        bottomFOV = -FOV / 2.0
        near = 300.0
        self.writeKML(est, nord, altitude,  heading, tilt, roll,
                      leftFOV, rightFOV, topFOV, bottomFOV, near)
...
<PhotoOverlay id="space-needle">
    ...
    def readKML(self):
            # Read a KML file created by th plugin or a KML for a picture pose
            # in google Earth
        path = self.pathToData + "/pose.kml"
            ...
            if(root.tagName() != "kml"):
                ...
                try:
                    ...
                    if altitudeMode != 'absolute':
                        QMessageBox.warning(
                            QMainWindow(), "Error", "Could not use xml file. Problem of altitude definition.")
    ...
    def dotIt(self):
        ...
        table = {}
        table['A'] = [(0, 0), (0.5, 1), (1, 2), (1.5, 3), (2, 4),
                      (2.5, 3), (3, 2), (3.5, 1), (4, 0), (1.5, 1), (2.5, 1)]  # A
        table['B'] = [(0, 0), (0, 1), (0, 2), (0, 3), (0, 4),
                      (1, 0), (2, 1), (1, 1.5), (1, 2.5), (2, 3.5), (1, 4)]
        table['C'] = [(0, 1), (0, 2), (0, 3), (1, 4), (2, 4), (1, 0), (2, 0)]
        table['D'] = [(0, 0), (0, 1), (0, 2), (0, 3), (0, 4),
                      (1, 0), (2, 0.5), (2, 1.5), (1, 4), (2, 2.5), (2, 3.5)]
        table['E'] = [
            (0, 0), (0, 1), (0, 2), (0, 3), (0, 4), (1, 0), (2, 0), (1, 2), (1, 4), (2, 4)]
        table['F'] = [
            (0, 0), (0, 1), (0, 2), (0, 3), (0, 4), (1, 2), (1, 4), (2, 4)]  # F
        table['G'] = [(0.5, 0), (1, 0), (2, 0), (3, 0.5), (3, 1),
                      (2.5, 1.5), (0, 1), (0, 2), (0, 3), (0.5, 4), (1, 4), (2, 4)]  # G
        table['H'] = [(0, 0), (0, 1), (0, 2), (0, 3), (0, 4),
                      (1, 2), (2, 0), (2, 1), (2, 2), (2, 3), (2, 4)]  # H
        table['I'] = [
            (0, 0), (1, 0), (2, 0), (1, 1), (1, 2), (1, 3), (1, 4), (0, 4), (2, 4)]  # I
        table['J'] = [
            (0, 0), (0, 1), (1, 0), (2, 0), (2, 1), (2, 2), (2, 3), (2, 4), (1, 4), (0, 4)]
        table['K'] = [(0, 0), (0, 1), (0, 2), (0, 3), (0, 4),
                      (1, 2), (2, 1), (3, 0), (2, 3), (3, 4)]  # K
        table['L'] = [
            (0, 0), (0, 1), (0, 2), (0, 3), (0, 4), (1, 0), (2, 0)]  # L
        table['M'] = [(0, 0), (0, 1), (0, 2), (0, 3), (0, 4), (1, 3.5),
                      (2, 3), (3, 3.5), (4, 0), (4, 1), (4, 2), (4, 3), (4, 4)]
        table['N'] = [(0, 0), (0, 1), (0, 2), (0, 3), (0, 4), (1, 3),
                      (2, 2), (3, 1), (4, 0), (4, 1), (4, 2), (4, 3), (4, 4)]  # N
        table['O'] = [(0, 0), (0, 1), (0, 2), (0, 3), (0, 4),
                      (1, 0), (1, 4), (2, 0), (2, 1), (2, 2), (2, 3), (2, 4)]  # O
        table['P'] = [(0, 0), (0, 1), (0, 2), (0, 3), (0, 4),
                      (1, 2), (1, 4), (2, 4), (2, 3), (2, 2)]  # P
        table['Q'] = [(0, 0), (0, 1), (0, 2), (0, 3), (0, 4), (1, 0),
                      (1, 4), (2, 0), (2, 1), (2, 2), (2, 3), (2, 4), (3, 0)]  # Q
        table['R'] = [(0, 0), (0, 1), (0, 2), (0, 3), (0, 4),
                      (1, 2), (1, 4), (2, 4), (2, 3), (2, 2), (1, 1), (2, 0)]  # R
        table['S'] = [
            (0, 0), (1, 0), (2, 1), (1, 2), (0, 3), (1, 4), (2, 4)]  # S
        table['T'] = [(2, 0), (2, 1), (2, 2), (2, 3), (2, 4),
                      (0, 4), (1, 4), (2, 4), (3, 4), (4, 4)]  # T
        table['U'] = [(0, 0), (0, 1), (0, 2), (0, 3), (0, 4),
                      (1, 0), (2, 0), (2, 1), (2, 2), (2, 3), (2, 4)]  # U
        table['V'] = [(2, 0), (1.5, 1), (1, 2), (0.5, 3),
                      (0, 4), (2.5, 1), (3, 2), (3.5, 3), (4, 4)]  # V
        table['W'] = [(2, 0), (1.5, 1), (1, 2), (0.5, 3), (0, 4), (2.5, 1),
                      (3, 2), (3.5, 1), (4, 0), (4.5, 1), (5, 2), (5.5, 3), (6, 4)]  # W
        table['X'] = [
            (0, 4), (1, 3), (2, 2), (3, 1), (4, 0), (0, 0), (1, 1), (3, 3), (4, 4)]  # X
        table['Y'] = [
            (0, 4), (1, 3), (2, 2), (0, 0), (1, 1), (3, 3), (4, 4)]  # Y
        table['Z'] = [(0, 4), (1, 4), (2, 4), (3, 4), (1, 1),
                      (2, 2), (3, 3), (1, 0), (2, 0), (3, 0), (4, 0)]  # X
        table[' '] = []
