...
from ..ui.ui_mesure3D import Ui_Mesure3D
...
class mesure3DDialog(QtGui.QDialog):
    ...
    def __init__(self):
        ...
        # self.path contains the path in picture coordinates. It is only used
        # for drawing
        self.path = []
        # self.total contains the total length of the path in meter (3D
        # distance)
        self.total = 0
